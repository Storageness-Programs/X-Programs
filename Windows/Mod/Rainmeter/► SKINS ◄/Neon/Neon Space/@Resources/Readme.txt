...
B=Settings
      ...
      6= You will find numbers 1-5 Right to launcher type skins example "Left Corner" use these numbers to edit the path (First row) and path name (second row)
         Note! the more advanced skins will have a dedicated settings skin, search for a gear icon on them.
	  
      7= Upgrade to the pro version to unlock all the other skins, unlock universal color, have the option to request 4 icons of your choice for the Left-corner skin and will recieve all updates in your inbox
	 Click on the Upgrade Botton on the menu skin under General Tab or on one color selection box.
		 Thanks For Downloading Neon Space rainmeter 2.3 Skin.

      8= if this Readme file keep reappearing after you reboot your pc, make sure it's unloaded on rainmeter manager.
